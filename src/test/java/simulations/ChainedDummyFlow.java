...
public class ChainedDummyFlow extends Simulation {
    ...
    private final ScenarioBuilder gameList = new ScenarioFactory("Chained Dummy Resource Test")
            .request(HttpMethod.GET, BasePath.RESOURCES)
